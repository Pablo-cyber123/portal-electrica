...
import { ArrowRight, Zap, LogIn, ChevronDown } from 'lucide-react'
    ...
    <main className="min-h-[200vh] bg-white overflow-hidden relative" ref={targetRef}>
      ...
      <nav className="fixed top-0 w-full p-6 z-50 bg-white/80 backdrop-blur-md border-b border-oxfordGrey-200">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-oxfordGrey-900">
          <div className="flex items-center gap-2 font-bold tracking-tighter text-2xl">
            <Zap className="h-6 w-6 text-utsGreen-300" /> UTS<span className="text-utsGreen-800 font-normal">ELÉCTRICA</span>
          </div>
          <div className="flex gap-6 items-center">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 w-72">
                <div className="bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-oxfordGrey-100 overflow-hidden flex flex-col p-2">
                  <TransitionLink href="/documentos" className="px-4 py-3 hover:bg-utsGreen-50 rounded-lg transition-colors group/link text-left">
                  ...
                  <TransitionLink href="/documentos" className="px-4 py-3 hover:bg-utsGreen-50 rounded-lg transition-colors group/link text-left mt-1">
      ...
      <div id="noticias" className="min-h-screen bg-white py-32 relative z-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div>
               <h2 className="text-5xl font-bold tracking-tighter text-oxfordGrey-900 mb-4">Actualidad <span className="text-utsGreen-800">Eléctrica</span></h2>
               <p className="text-xl text-oxfordGrey-400 max-w-2xl">Mantente al día con los últimos avisos, cortes de notas y eventos de la facultad.</p>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-4xl font-bold tracking-tighter text-oxfordGrey-900">Facebook <span className="text-utsGreen-800">Oficial</span></h2>
            </div>
            <p className="text-lg text-oxfordGrey-400 max-w-2xl">Últimas publicaciones de la página oficial de Ingeniería Eléctrica UTS en Facebook.</p>
          </motion.div>
