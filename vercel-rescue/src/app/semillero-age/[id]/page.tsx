...
import { ArrowLeft, Beaker, Calendar, Zap, ImageIcon, Video, FileText, Activity } from "lucide-react"

export const dynamic = "force-dynamic"

export default async function PublicProjectDetail({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params
  const { project, error } = await getPublicProjectDetails(id)
